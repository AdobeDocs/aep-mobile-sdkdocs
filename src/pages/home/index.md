...
The latest versions of the Adobe Experience Platform SDK for Android and iOS (Swift and Objective-C) have been tested for compatibility with the release versions of Google Android 16 and Apple iOS 26. See [Current SDK Versions](./current-sdk-versions.md) to find our latest SDK versions, or [release notes](./release-notes/index.md) for information on changes and updates.
