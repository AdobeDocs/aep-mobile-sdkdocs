...
This event is a request to complete processing on the Analytics hits queue. The event will be created when either of the [`trackAction`](../mobile-foundation-extensions/mobile-core/api-reference.md#trackaction) or [`trackState`](../mobile-foundation-extensions/mobile-core/api-reference.md#trackstate) APIs is called.
...
This event represents a request to the Lifecycle extension to start or stop collecting data and is generated when [lifecycleStart](../mobile-foundation-extensions/mobile-core/lifecycle/api-reference.md#lifecyclestart) and [lifecyclePause()](../mobile-foundation-extensions/mobile-core/lifecycle/api-reference.md#lifecyclepause) are used.
