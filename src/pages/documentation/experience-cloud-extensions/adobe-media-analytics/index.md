...
To update your SDK configuration programmatically, use the following information to change your Media configuration values. For more information, see [Configuration API reference](../../mobile-foundation-extensions/mobile-core/configuration/api-reference.md).
