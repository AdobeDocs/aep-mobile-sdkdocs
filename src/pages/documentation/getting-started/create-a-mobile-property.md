...
After Data Collection UI rights have been added to your Adobe ID, log in to the Data Collection UI. You can do this by going to [https://experience.adobe.com/\#/data-collection](https://experience.adobe.com/#/data-collection) or by logging in to the [Experience Cloud](https://experiencecloud.adobe.com), navigating to the Activation page, and selecting the Data Collection UI.
...
4. Type a name for the property and select **Mobile** as the platform.
   ...
   If necessary, you can change the [**Privacy**](../resources/privacy-and-gdpr.md#setting-privacy-status) setting later. FIX LINK
...
The default privacy status is set to _opted in_ and might impact data collection. For more information, see [Privacy and GDPR](../resources/privacy-and-gdpr.md). FIX LINK
...
1. In the Data Collection UI, on the details page for your mobile property, click the **Extensions** tab.
...
1. In the Data Collection UI, on your mobile property's details page, click the **Publishing Flow** menu.
