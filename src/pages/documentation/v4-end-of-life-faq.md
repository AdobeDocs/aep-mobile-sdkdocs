...
Yes! This end-of-support statement does not affect your use of Mobile Services in any way. You may continue to use features such as marketing links, push notifications, and in-app messaging with version 4 SDKs or by leveraging the Adobe Analytics - Mobile Services extension for the Experience Platform Mobile SDKs. Documentation for this can be found in the [previous versions of our documentation](https://developer.adobe.com/client-sdks/previous-versions/documentation/adobe-analytics-mobile-services/).
