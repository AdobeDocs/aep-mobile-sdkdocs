...
On iOS, the registration occurs by passing UserProfile extension to the [MobileCore.registerExtensions API](../mobile-foundation-extensions/mobile-core/api-reference.md#registerextension-s).
