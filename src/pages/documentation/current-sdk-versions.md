...
| Adobe Analytics| Not Supported - Analytics workflows supported through [Edge](../adobe-analytics/migrate-to-edge-network.md) or [Edge Bridge](../adobe-analytics/migrate-to-edge-network.md) extensions. |
