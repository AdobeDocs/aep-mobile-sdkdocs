...
To learn more about Project Griffon, here are the links to the [documentation](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/project-griffon): FIX LINK

* [Set up Project Griffon](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/project-griffon/set-up-project-griffon) FIX LINK
* [Using Project Griffon](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/project-griffon/using-project-griffon) FIX LINK
