...
This API has been deprecated as of version 2.0.0. Please use the [Mobile Core registerExtension API](../../home/base-extensions/mobile-core/api-reference.md) instead.
