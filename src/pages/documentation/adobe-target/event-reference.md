...
| **Key** | **Value Type** | **Required** | **Description** |
| :--- | :--- | :--- | :--- |
| `target.clientCode` | String | Yes | The Target Client Code that is obtained during provisioning with the Target Adobe solution. |
...
| `thirdpartyid` | String | No | Current Third Party ID that is set from the API. |
