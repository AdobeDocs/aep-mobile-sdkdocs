...
For more details see [Analytics response identity Document](../../adobe-analytics/event-reference.md#analytics-response-identity).
...
For more details see [Audience Manager Content Response Document](../../adobe-audience-manager/event-reference.md#audience-manager-content-response).
...
The Analytics Custom VID is no longer included in the Identity event data payload. If needed, it may be retrieved from the [Analytics extension](../../adobe-analytics/api-reference.md#getvisitoridentifier).
...
For more details about this event, see the [Mobile Core Configuration event reference](../configuration/event-reference.md) section.
...
For more details about this event see [Analytics Content Request](../../adobe-analytics/event-reference.md#analytics-content-request)
