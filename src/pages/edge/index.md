...
description: An overview listing the available extensions on Edge for the Adobe Experience Platform Mobile SDK.
keyword:
- Overview
---
...
Edge extensions are extensions that you can use with the Mobile SDKs that are built on the Edge.
