...
| :--- | :------- | :--- |
| Timestamp | Yes | The timestamp when the Experience Platform event is sent to the AEP Edge mobile extension. Automatically added by the SDK. |
| Event ID | Yes | Unique event identifier. Automatically added by the SDK. |
