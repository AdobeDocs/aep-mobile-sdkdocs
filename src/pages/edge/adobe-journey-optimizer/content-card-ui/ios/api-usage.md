...
* _listener_ - An optional [ContentCardUIEventListening](../ios/public-classes/contentcarduieventlistening.md) object to listen to UI events from the content card. If you do not need to listen to UI events from the content card, this parameter can be omitted.
* _completion_ - A completion handler that is called with a `Result` containing either:
    * _success_ - An array of [ContentCardUI](../ios/public-classes/contentcardui.md) objects representing the content cards to be displayed.
